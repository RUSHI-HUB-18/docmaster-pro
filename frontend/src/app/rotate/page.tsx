  ...
  return (
    <div className="flex-grow max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col gap-8 justify-center">
      ...
      <div className="text-center flex flex-col items-center gap-3">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-500 to-violet-600 flex items-center justify-center text-white shadow-md shadow-purple-500/10">
          <RotateCw className="w-6 h-6" />
        </div>
        <h1 className="text-3xl font-extrabold text-white tracking-tight">Rotate PDF</h1>
        <p className="text-slate-400 text-sm max-w-md">
          Rotate individual pages or the entire document clockwise or counterclockwise.
        </p>
      </div>
